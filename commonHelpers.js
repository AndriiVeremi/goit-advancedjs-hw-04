...
</a>`).join("")}function a(n,t){n.classList.toggle("hidden",!t)}function L(){const{height:n}=document.querySelector(".gallery").firstElementChild.getBoundingClientRect();window.scrollBy({top:n*2,behavior:"smooth"})}const o={form:document.querySelector("#search-form"),input:document.querySelector("input"),gallery:document.querySelector(".gallery"),loadBtn:document.querySelector(".js-load-btn"),logo:document.querySelector(".js-pixa")};o.form.addEventListener("submit",v);o.loadBtn.addEventListener("click",S);a(o.loadBtn,!1);a(o.logo,!0);const h=new b(".js-gallery a",{captionDelay:250,captionsData:"alt"});let d="",u=1;function f(){o.gallery.innerHTML="",u=1}async function v(n){n.preventDefault(),a(o.loadBtn,!1);const t=o.input.value.trim().toLowerCase();if(!t){c.show({title:"Ops!",message:"Enter something to search!",position:"topRight"});return}if(d===t){c.show({title:"Sorry!",message:"Rewrite your requests, write something different.!",position:"topRight"});return}d=t,f();try{const r=await g(d,u),i=r.data.totalHits,e=r.data.hits;if(i===0){a(o.loadBtn,!1),a(o.logo,!0),c.show({title:"Ops!",message:"We're sorry, but you've reached the end of search results.",position:"topRight"});return}a(o.logo,!1),o.gallery.insertAdjacentHTML("afterbegin",p(e)),c.show({title:"Hooray!",message:`We found ${i} images.`,position:"topRight"}),a(o.loadBtn,!0),h.refresh()}catch(r){console.log(r),f(),a(o.logo,!0)}}async function S(n){n.preventDefault(),u+=1;try{const t=await g(d,u),r=t.data.hits,i=t.data.totalHits;u<Math.ceil(i/40)||(c.show({message:"We're sorry, but you've reached the end of search results.",position:"topRight"}),a(o.loadBtn,!1)),o.gallery.insertAdjacentHTML("beforeend",p(r)),L(),h.refresh()}catch(t){console.log(t),f(),a(o.logo,!0)}}
